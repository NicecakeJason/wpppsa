    ...
    <section class="section">
        <div class="container">
                                    ...
                                    <div class="rules-section">
                                        ...
                                        <ul class="rules-list">
                                            ...
                                            <li class="rule-item">
                                                ...
                                                <span class="rules rules-deposit">*Депозит возвращается в полном размере после
                                                    проверки
                                                    состояния
                                ...
                                <div class="position-sticky" style="top:60px;">
                                    <div class="price">
                                        <div class="price-info">
                                            ...
                                            <?php echo do_shortcode('[sunapartament_booking_form]'); ?>
            ...
            ?>
                ...
                get_template_part('template-parts/section-accardion');
